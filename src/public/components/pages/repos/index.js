  ...
  setRepos() {
    this.reps.map(repo => {
      if (repo.name != "loleus.github.io" && !(repo.description.includes('#'))) {
        tmp.getElementById("repos").innerHTML += `
          <tr>
            <td id="name" style="background-image:url('https://loleus.github.io/${repo.name}/bog.jpg'); background-size:cover"><a target="_blank" href="https://loleus.github.io/${repo.name}">${repo.name}</a></td>
