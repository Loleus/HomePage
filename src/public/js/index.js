...
const routes = [
  ["wc-router", Router], ["wc-home", Home], ["wc-repos", Repos], ["wc-about", AboutMe], ["wc-music", Music], ["wc-video", Video], ["wc-contact", Contact], ["wc-login", Login], ["wc-addphoto", AddPhoto], ["wc-editphoto", EditPhoto], ["wc-photos", Photos], ["wc-photo", Photo], ["wc-notfound", NotFound],["wc-spinner", Spinner]
];
...
export { Router, Home, Repos, AboutMe, Music, Video, Contact, Login, AddPhoto, EditPhoto, Photos, Photo, NotFound, Menu,  Spinner};
